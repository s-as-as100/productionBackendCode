...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  const deleteOldCoverImage = req.user?.coverImage; // Assuming 'coverImage' field stores the path of the old cover image
  if (deleteOldCoverImage) {
    // Delete the old cover image from the filesystem
    fs.unlink(deleteOldCoverImage, (err) => {
      if (err) {
